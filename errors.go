...
import (
	...
	"git.changbaops.com/golang/protoc-gen-go-errors/errors"
)

const (
	errorsPackage    = protogen.GoImportPath("github.com/go-kratos/kratos/v2/errors")
	pkgErrorsPackage = protogen.GoImportPath("github.com/pkg/errors")
...
func generateFile(gen *protogen.Plugin, file *protogen.File) *protogen.GeneratedFile {
	...
	g.QualifiedGoIdent(pkgErrorsPackage.Ident("pkgError"))
